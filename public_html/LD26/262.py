...
# Studenta Apliecības numurs: 141REB187
# Datums: 20.03.2015.
# Programmas apraksts: Elektriskās shēmas animācija

import Tkinter as tk
import time

root = tk.Tk()
root.title("Elektriskās shēmas animācija")
...
b3= tk.Button(root, text="Dzes U1 objektus", command = fun3)
b3.pack(side="right")
